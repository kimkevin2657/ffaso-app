...
function TeacherBottomTabBar({ state, descriptors, navigation }) {
  // const dispatch = useDispatch();
  // const { currentScreen } = useSelector((state) => state.gym);
    ...
    <View style={styles.wrapper}>
      <View style={styles.container}>
        {state.routes.map((route, index) => {
          ...
          const onPress = () => {
            if (route.name === 'TeacherCenterList') {
              // dispatch(onChangeGymFilter(true));
            }
